...
object Constants {
    ...
    const val DEFAULT_MESSAGE = "Help! I'm in danger and need assistance. Please send help immediately."
    const val TUTORIAL_LINK = "https://www.youtube.com/watch?v=9EN-IRcAgPU"
}